...
SELECT 
   ...
   COUNT(*) as india_yearly_content,
   ROUND(
   COUNT(*) ::numeric/(SELECT COUNT (*) FROM netflix WHERE country = 'India')::numeric * 100, 2) as india_avg_content_per_year
